...
public class timer : MonoBehaviour {
    ...
    string[] tabJeux1 = { "TapTaup" };
    string[] tabJeux2 = { "TapTaup", "Labyrinthe" };
    string[] tabJeux3 = { "TapTaup" };
    string[] tabJeux4 = { "TapTaup", "Labyrinthe" };
    string[] tabJeux5 = { "TapTaup" };
    string[] tabJeux6 = { "TapTaup", "Labyrinthe" };
